...
print(f"{year}, {name}, for about $${float(cost):, .2f}")
...
for i in range(11):  # Loop through values from 0 to 10
    result = 2 ** i  # Calculate 2 raised to the power of i
    print(f"2 ^ {i:2} is {result:4}")  # Use f-string for right-aligned formatting